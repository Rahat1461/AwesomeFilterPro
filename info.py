...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6976744562', '6964538561').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('1002400133611', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('1002400133611')
auth_grp = environ.get('1002287511910')
...
SUPPORT_CHAT = environ.get('1002287511910', ')
