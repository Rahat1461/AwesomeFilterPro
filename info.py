...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('2234319295', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('1002198886089')
...
# Others
LOG_CHANNEL = int(environ.get('2162182935', 0))
